...
const Services = () => {
    ...
    const [hidden1, setHidden1] = React.useState<boolean>(true)
    const [hidden2, setHidden2] = React.useState<boolean>(true)
    const [hidden3, setHidden3] = React.useState<boolean>(true)
    return (
