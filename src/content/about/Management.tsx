                ...
                <div className='flex flex-wrap justify-center text-center mb-8'>
                    <div className='w-full lg:w-6/12 px-4'>
                        <h2 className='text-4xl font-semibold'>
                            Our Super Management
                        </h2>
                        <p className='text-lg leading-relaxed m-4 text-gray-600'>
                            We boast of an amazing leadership team with vast
                            experience in handling construction projects of any
                            type and size.
                        </p>
                    </div>
                </div>
                    ...
                    <div className='w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4'>
                        <div className='px-6'>
                            ...
                            <div className='pt-6 text-center'>
                                ...
                                <div className='mt-6 flex justify-evenly h-10'>
                                    <button
